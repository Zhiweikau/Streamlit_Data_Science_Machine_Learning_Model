...
st.markdown("---")
# Check if the data is already loaded in the session state
if "data" in st.session_state:
    ...
    if st.button("Press this Button to Detect the Variables with Unique Value < 5"):
        unique_values = data.nunique()
    ...
    st.markdown("<p style='color:red; font-weight:bold;'>Please upload a CSV file in the Data to load the data for EDA.</p>", unsafe_allow_html=True)